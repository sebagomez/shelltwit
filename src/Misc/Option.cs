	...
	internal class Option
	{
		...
		public static Option Timeline()
		{
			Option o = new Option()
			{
				...
				Argument = "[count]",
				IsDefault = true,
				Action = async (u, s) => await PrintActions.UserTimeLine(u, s)
			};
		...
		public static Option Query()
		{
			Option o = new Option()
			{
				...
				Argument = "<query>",
				Action = async (u, s) => await PrintActions.UserSearch(u, s)
			};
		...
		public static Option Mentions()
		{
			Option o = new Option()
			{
				...
				Action = async (u, s) => await PrintActions.UserMentions(u)
			};
		...
		public static Option User()
		{
			Option o = new Option()
			{
				...
				Argument = "<handle>",
				Action = async (u, s) => await PrintActions.UserTwits(u, s)
			};
		...
		public static Option Likes()
		{
			Option o = new Option()
			{
				...
				Action = async (u, s) => await PrintActions.UserLikes(u)
			};
		...
		public static Option Update()
		{
			Option o = new Option()
			{
				Action = async (u, s) => await PrintActions.UpdateStatus(u, s)
			};
		...
		public static Option DirectMessage()
		{
			Option o = new Option()
			{
				...
				Action = async (u, s) => await PrintActions.DirectMessage(u, s)
			};
		...
		public static Option DMList()
		{
			Option o = new Option()
			{
				...
				Argument = "",
				Action = async (u, s) => await PrintActions.ListDMs(u, s)
			};
